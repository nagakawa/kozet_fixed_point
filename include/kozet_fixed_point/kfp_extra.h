...
namespace kfp {
  ...
  static constexpr size_t CORDIC_ITERATIONS = 31;
  // CORDIC K constant in 2.30 format.
  static constexpr s2_30 CORDIC_K = s2_30::raw(0x26DD3B6A);

  // The arctangents of 2**(-i) for i = 0, 1, ... 31.
  // Generated by this Perl6 expression:
  // ((^32).map({"s2_30::raw(0x"~(2**30*atan(2**-$_)).floor.base(16)~")"})).join(", ")
  const s2_30 arctangents[] = {
    s2_30::raw(0x3243F6A8), s2_30::raw(0x1DAC6705), s2_30::raw(0xFADBAFC), s2_30::raw(0x7F56EA6),
    s2_30::raw(0x3FEAB76), s2_30::raw(0x1FFD55B), s2_30::raw(0xFFFAAA), s2_30::raw(0x7FFF55),
    s2_30::raw(0x3FFFEA), s2_30::raw(0x1FFFFD), s2_30::raw(0xFFFFF), s2_30::raw(0x7FFFF),
    s2_30::raw(0x3FFFF), s2_30::raw(0x1FFFF), s2_30::raw(0xFFFF), s2_30::raw(0x7FFF),
    s2_30::raw(0x3FFF), s2_30::raw(0x1FFF), s2_30::raw(0xFFF), s2_30::raw(0x7FF),
    s2_30::raw(0x3FF), s2_30::raw(0x1FF), s2_30::raw(0xFF), s2_30::raw(0x7F),
    s2_30::raw(0x3F), s2_30::raw(0x1F), s2_30::raw(0xF), s2_30::raw(0x8),
    s2_30::raw(0x4), s2_30::raw(0x2), s2_30::raw(0x1), s2_30::raw(0x0)
  };

  // Like the previous, but with angles expressed in turns instead of radians.
  // ((^32).map({"frac32::raw(0x"~(2**32*atan(2**-$_)/tau).floor.base(16)~")"})).join(", ")
  const frac32 arctangentsT[] = {
    ...
    frac32::raw(0x2), frac32::raw(0x1), frac32::raw(0x0), frac32::raw(0x0)
  };
  ...
  const s2_30 intermediateKRatio[] = {
